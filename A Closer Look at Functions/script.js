...
// Closures - not a feature we explicitly use, JS does it automatically, cannot access the variables, but can look at it
...
// reassigning f, old closure disappear
h();
f();
console.dir(f);
