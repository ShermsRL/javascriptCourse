...
// JS store in base 2 which will result in weird decimal numbers
console.log(0.1 + 0.2);

console.log(Number('23'));
// Can use the + sign to replace the Number
console.log(+'23');

// Parsing
// string must start with number - will get rid of unnecessary symbols
...
// isNaN is not perfect as it does not consider 23 / 0 = Infinite
console.log(Number.isNaN(23 / 0));

// checking if its finite - better version of isNaN
...
// Rounding decimals
// toFixed will return string, toFixed to specify how many decimal points
...
// Numeric separators
// 287,460,000,000
// use underscore to make numbers more readable
...
// underscore must be between numbers, no symbols before or after
const PI = 3.14_15;
console.log(PI);
...
// timers: set timeout and set interval - function only run once
...
// setinterval - run at every set interval
